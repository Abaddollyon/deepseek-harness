...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  clientSurfaces: 'client-modules.md',
  ...
  pendingInteractions: 'approval.md',
  planMode: 'plan.md',
  ...
  directoryBrowserController: 'workspace.md',
}
...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  connectionFactory: 'client-side connection factory service — packages/client/connection/README.md owns the API',
  ...
  environmentComposition: 'client-side environment composition service — packages/client/environment-runtime/README.md owns the API',
  environmentNavigation: 'client-side environment navigation service — packages/client/environment-runtime/README.md owns the API',
  environmentRuntime: 'client-side environment runtime service — packages/client/environment-runtime/README.md owns the API',
  ...
  uiSidebar: 'client-side sidebar interaction service — packages/client/ui-sidebar/README.md owns the API',
  ...
  clientRuntimeActivator: 'client-side runtime activation service — packages/client/web/README.md owns the API',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  IndexRenderContext: 'web-server.md',
  ...
  PendingInteractionBegin: 'approval.md',
  PendingInteractionChange: 'approval.md',
  PendingInteractionSnapshot: 'approval.md',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  JobRecord: 'durable job record shape is owned by packages/jobs/jobs-store-domain/README.md',
