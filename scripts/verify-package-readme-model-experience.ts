...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/experimental/code-runtime-python': { kind: 'indirect', reason: 'The CPython subprocess backend delegates model rendering to Code Mode in dsh-tools.' },
  'packages/util/deque': { kind: 'none', reason: 'The in-process collection registers nothing model-facing.' },
  'packages/util/time': { kind: 'indirect', reason: 'The utility delegates model-visible rendering to its consuming context package.' },
  'packages/util/values': { kind: 'none', reason: 'The JSON utility registers nothing model-facing.' },
  ...
  'packages/interaction/pending-interactions': { kind: 'none', reason: 'Host-side passive lifecycle metadata; registers nothing model-facing.' },
  ...
  'packages/client/environment-runtime': { kind: 'none', reason: 'Browser-side Host runtime composition; registers nothing model-facing.' },
  ...
  'packages/client/ui-environment-navigation': { kind: 'none', reason: 'Browser-side UI plugin layer; registers nothing model-facing.' },
  ...
  'packages/host/directory-browser': { kind: 'none', reason: 'The display-free GUI Host browsing seam registers nothing model-facing.' },
  'packages/host/directory-browser-filesystem': { kind: 'none', reason: 'The GUI Host filesystem browser registers nothing model-facing.' },
  ...
  'packages/web/web-search-codex': { kind: 'indirect', reason: 'The provider backend delegates model rendering to dsh-tool-web.' },
  'packages/web/web-search-exa': { kind: 'indirect', reason: 'The provider backend delegates model rendering to dsh-tool-web.' },
  'packages/web/web-search-claude-code': { kind: 'indirect', reason: 'The provider backend delegates model rendering to dsh-tool-web.' },
  'packages/workflow/workflow': { kind: 'indirect', reason: 'The service delegates parent and child model rendering to its consumer and engine.' },
  'packages/api/session-controller': { kind: 'none', reason: 'The BFF exposes session control while invoked Agent commands own every model-visible effect.' },
  'packages/api/settings-controller': { kind: 'none', reason: 'The BFF exposes browser and Host configuration state and registers no prompt, tool, or session event.' },
  'packages/api/workspace-controller': { kind: 'none', reason: 'The BFF exposes browser and Host Workspace control state and registers no prompt, tool, or session event.' },
  'packages/client/store': { kind: 'none', reason: 'Browser-side state primitives register nothing model-facing.' },
  'packages/client/ui-approval': { kind: 'none', reason: 'The browser approval surface renders Host requests without altering model context.' },
  'packages/client/ui-chat': { kind: 'none', reason: 'The browser Chat surface renders logged conversation state without altering model context.' },
  'packages/client/ui-session': { kind: 'none', reason: 'The browser Session adapter exposes selectors and Slot scopes without assembling model requests.' },
  'packages/experimental/agent-team-web-profile': { kind: 'indirect', reason: 'The Web bundle delegates all model-facing Team behavior to the selected Host profile.' },
  'packages/experimental/client-ui-agent-team': { kind: 'none', reason: 'The browser Team projection and controls register no model-facing input.' },
  'packages/experimental/inspector': { kind: 'none', reason: 'The developer inspector observes runtime activity without changing model requests.' },
  'packages/experimental/webworker-packer': { kind: 'none', reason: 'The build-time packer writes an image and does not contribute to model requests.' },
  'packages/experimental/webworker-runtime': { kind: 'none', reason: 'The browser worker host delegates every model-facing registration to the plugins it boots.' },
  'packages/llm/deepseek-llm-api-extensions': { kind: 'indirect', reason: 'The registry delegates provider metadata rendering to dsh-llm-deepseek.' },
  'packages/test-support/session-snapshot': { kind: 'none', reason: 'The test-only harness records and compares sessions without changing assembled model requests.' },
  'packages/util/crypto': { kind: 'indirect', reason: 'Identifier consumers own any request changes; minted identifiers carry no semantic prompt content.' },
  'packages/util/workspace-path': { kind: 'none', reason: 'Browser-safe path helpers format values for callers and register nothing model-facing.' },
  'packages/webhook/webhook-github': { kind: 'indirect', reason: 'The adapter delegates Session requests and model-visible text to matching dsh-webhook rules.' },
}
