...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/jobs/run-supervisor': { kind: 'indirect', reason: 'Boot outcomes reach the model through live-owner completion notices and job-tool results; run events remain log-only.' },
