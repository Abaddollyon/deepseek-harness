...
来源： [`packages/core/agent-loop/src/index.ts:328`](../packages/core/agent-loop/src/index.ts)
...
export interface Config {
  ...
  /** Maximum physical bytes eligible for a cold blankness probe; zero disables probes. */
...
依赖于： [`ModelModality`](../packages/llm/llm/src/index.ts) · [`RetryPolicyConfig`](../packages/llm/llm/src/index.ts) · [`SystemPromptUpdate`](../packages/llm/llm/src/index.ts)
...
来源： [`packages/llm/llm-pi-ai/src/config.ts:268`](../packages/llm/llm-pi-ai/src/config.ts)
