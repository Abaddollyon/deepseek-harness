...
The loop sends immutable requests with live cancellation; [agent-loop](../packages/core/agent-loop/README.md#understand-the-implementation) owns request construction, prompt reconciliation, and resume semantics.
