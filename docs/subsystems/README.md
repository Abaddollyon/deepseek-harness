...
| [mcp.md](mcp.md) | the MCP host-connection seam: settings-backed connection entries, the Host connection owner and its OAuth engine seam, consumer bindings, token-free status views, and local-first revocation |
