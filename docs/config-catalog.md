...
Depends on: [`AgentBudget`](../packages/core/agent/src/index.ts) · [`ModelSelection`](subsystems/core.md)
...
Source: [`packages/host/directory-browser-filesystem/src/index.ts:179`](../packages/host/directory-browser-filesystem/src/index.ts)
...
Source: [`packages/llm/llm-pi-ai/src/config.ts:268`](../packages/llm/llm-pi-ai/src/config.ts)
...
Source: [`packages/shell/tool-pwsh-persistent/src/index.ts:522`](../packages/shell/tool-pwsh-persistent/src/index.ts)
...
- `@deepseek-ai/dsh-host-directory-picker-browse` — requires `directoryBrowser` ([`packages/host/directory-picker-browse/src/index.ts`](../packages/host/directory-picker-browse/src/index.ts))
