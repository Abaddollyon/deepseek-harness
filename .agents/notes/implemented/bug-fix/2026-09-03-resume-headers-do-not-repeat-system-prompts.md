...
This note's request-series presentation decision is superseded by [the V3 fork-capability reconciliation note](../architecture/2026-09-09-v3-fork-capability-reconciliation.md): an unchanged resume request-series card remains visible, while the reconstructed request still has one effective system node.
