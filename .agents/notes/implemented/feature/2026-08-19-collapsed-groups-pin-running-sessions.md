...
Extends the folding and order rules in [Workspace Sidebar Order and Folding](2026-08-11-workspace-sidebar-order-and-folding.md), which owns the zero-or-five open state and the transient **Show more** gesture this decision leaves intact.
