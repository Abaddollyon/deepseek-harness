...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  {
    ...
    kind: 'list',
    scope: 'root',
    summary: 'Root-scoped active page layer constrained to the center column.',
    doc: 'Root-scoped active page layer constrained to the center column. Shell\nnavigation uses this additive seat for views such as Environments while\nthe sidebar and single renderer remain mounted.',
    registerOptions: [
      {
        name: 'id',
    ...
    occupants: [
      'client-ui-environment-navigation EnvironmentOverview id \'environment-overview\'',
    ],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'active.content\', () => ctx.slots.register(\n      { name: \'active.content\', id: \'my-entry\', order: 100, label: \'My entry\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
  ...
  {
    key: 'environment.overview.content',
    kind: 'single',
    scope: 'root',
    summary: 'Active full-content environment overview supplied by a Host catalog plugin.',
    doc: 'Active full-content environment overview supplied by a Host catalog plugin.',
    registerOptions: [],
    ownerProps: [],
    ownerPropsReferences: [],
    standardProps: [
    ...
    hookContext: '',
    slotInject: '',
    declaredBy: 'an entry in \'active.content\' (client-ui-environment-navigation), so it exists while that entry is mounted',
    occupants: [],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'environment.overview.content\', () => ctx.slots.register(\n      { name: \'environment.overview.content\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-environment-navigation/src/client/EnvironmentNavigation.tsx:14',
  },
  {
    key: 'root',
    kind: 'single',
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'root',
    summary: 'Activity projection supplied by the active product bundle.',
    doc: 'Activity projection supplied by the active product bundle.',
    registerOptions: [],
    ownerProps: [
    ...
    hookContext: '',
    slotInject: '',
    declaredBy: 'an entry in \'sidebar.workspaces.content.overlay\' (client-ui-environment-navigation), so it exists while that entry is mounted',
    occupants: [],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'sidebar.activity\', () => ctx.slots.register(\n      { name: \'sidebar.activity\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
    source: 'packages/client/ui-environment-navigation/src/client/EnvironmentNavigation.tsx:16',
  },
  {
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'sidebar\' (client-ui-sidebar), so it exists while that entry is mounted',
    occupants: [
      'client-ui-environment-navigation EnvironmentFooterAction id \'environments\'',
  ...
  },
  {
    ...
    kind: 'list',
    scope: 'root',
    summary: 'Ordered sections above the workspace browser.',
    doc: 'Ordered sections above the workspace browser. External plugins use this\nseat for sidebar domains that need the shell\'s wide/rail geometry without\ntaking ownership of workspace browsing.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
    ...
    occupants: [],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'sidebar.workspace.section\', () => ctx.slots.register(\n      { name: \'sidebar.workspace.section\', id: \'my-entry\', order: 100, label: \'My entry\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
  ...
  {
    key: 'sidebar.workspaces.content.overlay',
    kind: 'single',
    scope: 'root',
    summary: 'Alternate body rendered inside the existing Workspaces browsing region.',
    ...
    occupants: [
      'client-ui-environment-navigation ActivityContent',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    kind: 'list',
    scope: 'root',
    summary: 'Compact actions rendered with the existing Workspaces section heading.',
    doc: 'Compact actions rendered with the existing Workspaces section heading.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
    ...
    declaredBy: 'an entry in \'sidebar.workspaces\' (client-ui-workspace), so it exists while that entry is mounted',
    occupants: [
      'client-ui-environment-navigation ActivityToggle id \'environment-activity-toggle\'',
    ],
    replaceRisk: 'none',
