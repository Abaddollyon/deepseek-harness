...
export const SERVICE_API: readonly ServiceApiEntry[] = [
  ...
  },
  {
    ...
    methods: [
      ...
      {
        signature: 'async create( id: SessionId, options: AgentOptions = {}, meta: { readonly cwd?: string; readonly additionalPaths?: readonly string[] } = {}, ): Promise<Agent>',
  ...
  },
  {
    ...
    methods: [
      {
        signature: 'checkpointFor(meta: SessionHeader, inheritedEventCount: SessionLogOffset): ProjectionCheckpoint | undefined',
        description: 'Return identity-checked rows for a cold reader.',
        parameters: [{ name: 'meta', description: 'stored session header used as lifecycle identity witness.' }, { name: 'inheritedEventCount', description: 'exact inherited prefix in the stored lifecycle.' }],
      ...
      },
      {
        ...
        description: 'Durably checkpoint one Session (all mandatory points call this; tests and carriers may too). The registry returns detached rows at invocation. Writes enter the per-session queue before waiting for log durability, preserving snapshot order even when flushes finish out of order. NOT fail-soft — callers on the fail-soft paths contain it.',
        parameters: [{ name: 'session', description: 'the live or just-detached Session to checkpoint.' }],
  ...
  },
  {
    ...
    methods: [
      ...
      },
      {
        ...
        description: 'Estimate tool-schema tokens in one canonical request envelope. System messages are priced separately as surface nodes.',
  ...
  },
  {
    ...
    methods: [
      ...
      },
      {
        ...
        description: 'Replace one Workspace\'s additional directory roots atomically.',
        parameters: [{ name: 'request', description: 'Workspace identity and additional roots.' }],
        returns: 'the updated Workspace projection.',
      },
      {
  ...
  },
  {
    ...
    methods: [
      {
        signature: 'async create(path: string, title?: string, additionalPaths?: readonly string[]): Promise<Workspace>',
        ...
        parameters: [{ name: 'path', description: 'Existing directory to own, in a fully qualified path spelling.' }, { name: 'title', description: 'Display title used only when a new record is created.' }, { name: 'additionalPaths', description: 'Existing directories to canonicalize; supplied roots must match when reusing a workspace.' }],
