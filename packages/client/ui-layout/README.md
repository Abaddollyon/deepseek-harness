...
The root-scoped `active.content` list overlays only the center column for Environment navigation while retaining the conversation and sidebar. `shell.overlay` remains frame-wide.
