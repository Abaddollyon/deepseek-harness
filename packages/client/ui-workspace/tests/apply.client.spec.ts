...
describe('ui-workspace apply', () => {
  ...
  it('declares the two directory-flow holes and reports their occupancy per surface', async () => {
    ...
    expect(b.slots.spec('sidebar.workspaces.header.action')).toMatchObject({ kind: 'list' })
    expect(b.slots.spec('sidebar.workspaces.content.overlay')).toMatchObject({ kind: 'single' })
