...
export const zh = {
  ...
  'diagnostic.cycle': '子代理血缘存在循环',
  'view.swarm': 'Agent 集群',
  'flow.title': 'Agent 流程',
  'flow.empty': '当前会话没有子代理后代',
  'flow.summary': '{total} 个代理 · {running} 个运行中 · {settled} 个已结束',
  'identity.unavailable': '提供方/模型不可用',
  'identity.unavailablePart': '不可用',
  'identity.preset': '预设：{preset}',
  'metric.depth': '深度 {depth}',
  'metric.tokens': '{tokens} tokens',
  'metric.duration': '活跃 {duration}',
  'metric.turnsSteps': '{turns} 轮 · {steps} 步',
  'row.open': '打开 {label}',
  'row.refresh': '刷新 {label} 的地址',
  'row.aria': '{label}，{state}，{identity}，{tokens} tokens，{duration}，深度 {depth}',
  'row.diagnosticAria': '{label}，{reason}，深度 {depth}',
...
export const en: Record<SubagentKey, string> = {
  ...
  'diagnostic.cycle': 'subagent lineage contains a cycle',
  'view.swarm': 'Swarm',
  'flow.title': 'Agent flow',
  'flow.empty': 'No descendant agents in this session',
  'flow.summary': '{total} agents · {running} running · {settled} settled',
  'identity.unavailable': 'provider/model unavailable',
  'identity.unavailablePart': 'unavailable',
  'identity.preset': 'preset: {preset}',
  'metric.depth': 'depth {depth}',
  'metric.tokens': '{tokens} tokens',
  'metric.duration': 'active {duration}',
  'metric.turnsSteps': '{turns} turns · {steps} steps',
  'row.open': 'Open {label}',
  'row.refresh': 'Refresh the address for {label}',
  'row.aria': '{label}, {state}, {identity}, {tokens} tokens, {duration}, depth {depth}',
  'row.diagnosticAria': '{label}, {reason}, depth {depth}',
