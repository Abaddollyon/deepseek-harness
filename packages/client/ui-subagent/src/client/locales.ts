...
export const zh = {
  ...
  'history.label': '未运行的子代理（{count}）',
  'activity.descendants': '{count} 个后代正在运行',
  'session.open': '打开',
  'session.openLabel': '打开 {label} 的会话',
...
export const en: Record<SubagentKey, string> = {
  ...
  'history.label': 'Inactive agents ({count})',
  'activity.descendants': 'running descendants: {count}',
  'session.open': 'Open',
  'session.openLabel': 'Open {label} conversation',
