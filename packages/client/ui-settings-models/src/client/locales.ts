...
export const en = {
  ...
  automaticDiscovery: 'Automatic model discovery',
  automaticDiscoveryHint: 'Refresh this provider’s selectable models in the background. Explicit model settings stay unchanged.',
  baseUrl: 'Base URL',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  customized: '自定义设置',
  automaticDiscovery: '自动发现模型',
  automaticDiscoveryHint: '在后台刷新此提供方的可选模型。显式模型设置保持不变。',
  baseUrl: 'API 地址',
