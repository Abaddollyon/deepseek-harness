---
description: "Package map for the human-collaboration capability family: slash commands, one-shot approvals, passive pending status, permission presets, and the question/answer seam that lets a running agent pause for a human decision."
kind: "package-group"
---
...
| [`pending-interactions/`](pending-interactions/README.md) | Exposes content-free snapshots and lifecycle changes to passive status consumers | `ctx.pendingInteractions` |
