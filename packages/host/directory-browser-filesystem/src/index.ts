/**
 * Filesystem provider of the directory-browser seam: one-level directory listing and child-directory
 ...
 * @module @deepseek-ai/dsh-host-directory-browser-filesystem
 */
...
export default class FilesystemDirectoryBrowser extends DirectoryBrowser {
  /**
