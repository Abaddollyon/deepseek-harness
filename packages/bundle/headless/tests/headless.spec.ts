...
import { LlmAttemptId, ReasoningEffortId, createAssistantMessage, type StreamChunk } from '@deepseek-ai/dsh-llm'
  ...
  ctx.agents.setFactory({
    async createAgent(ownerCtx: Context, options: CreateAgentOptions): Promise<AgentHandle> {
      ...
      const agent: Agent = {
        ...
        hasExecutionBudget: options.agentOptions?.budget !== undefined,
        session,
        inbox,
        status: 'idle',
        ctx: ownerCtx,
